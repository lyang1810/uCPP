%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -*- Mode: Latex -*- %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 
%% uC++ Version 6.1.0, Copyright (C) Peter A. Buhr
%% 
...
%% Last Modified On : Thu Feb 19 07:40:03 2015
%% Update Count     : 6752
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\Large Peter A. Buhr and Richard A. Stroobosscher \copyright\footnotemark[\thefootnote] 1992 \\
} % author
...
the main (starting) routine is a member of an initial task called \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}\index{uMain@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}}\index{initial task!uMain@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}}, which has the following structure (\VRef{s:Task} details the task construct):
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Task}\0\V{uMain}\0\{}}
\L{\LB{\0\0\K{private}:}}
\L{\LB{}\Tab{4}{\K{int}\0\V{argc};}\Tab{28}{\C{}\1\1\0number\0of\0arguments\0on\0the\0shell\0command\0line}}
\CE{}\L{\LB{}\Tab{4}{\K{char}\0\*\*\V{argv};}\Tab{28}{\C{}\1\1\0pointers\0to\0tokens\0on\0the\0shell\0command\0line}}
\CE{}\L{\LB{}\Tab{4}{\K{int}\0\&\V{uRetCode};}\Tab{28}{\C{}\1\1\0return\0value\0to\0the\0shell}}
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{main}();}\Tab{28}{\C{}\1\1\0user\0provides\0body\0for\0this\0routine}}
\CE{}\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{uMain}(\0\K{int}\0\V{argc},\0\K{char}\0\*\V{argv}[\,]\0)\0:\0\V{argc}(\V{argc}),\0\V{argv}(\V{argv})\0\{\}}}
\L{\LB{\};}}
\endlgrinde\LGend
\index{uMain@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}!argc@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{argc}}}\endlgrinde\LGend{}}%
\index{uMain@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}!argv@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{argv}}}\endlgrinde\LGend{}}%
\index{uMain@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}!uRetCode@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uRetCode}}}\endlgrinde\LGend{}}%
A \uC program must define the body for the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{uMain::main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{}} member routine of this initial task, e.g.:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{.\,.\,.\0\C{}\1\1\0normal\0C++\0declarations\0and\0routines}}
\CE{}\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}\Tab{28}{\C{}\1\1\0body\0for\0initial\0task\0uMain}}
\CE{}\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{}\Tab{4}{\K{switch}(\0\V{argc}\0)\0\{}\Tab{28}{\C{}\1\1\0use\0argc\0from\0uMain}}
\CE{}\L{\LB{}\Tab{4}{\0\0\K{case}\02:}}
\L{\LB{}\Tab{8}{\V{no}\0=\0\V{atoi}(\V{argv}[1]);}\Tab{28}{\C{}\1\1\0use\0argv\0from\0uMain}}
\CE{}\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{}\Tab{4}{\V{uRetCode}\0=\00;}\Tab{28}{\C{}\1\1\0use\0uRetCode\0from\0uMain}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
\uC supplies the free routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} to initialize the \uC runtime environment and creates the task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}, of which routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} is a member.
Member \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} has available, as local variables, the same two arguments that are passed to the free routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}: \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{argc}}}\endlgrinde\LGend{}\index{argc@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{argc}}}\endlgrinde\LGend{}}, and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{argv}}}\endlgrinde\LGend{}\index{argv@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{argv}}}\endlgrinde\LGend{}}.
To return a value back to the shell, set the variable \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uRetCode}}}\endlgrinde\LGend{}\index{uRetCode@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uRetCode}}}\endlgrinde\LGend{}} and return from \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{};
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uRetCode}}}\endlgrinde\LGend{} is initialized to zero.
...
the first task created in the user cluster is \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}, which begins executing the member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{}.
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\#ifdef}\0\V{\_\_U\_CPLUSPLUS\_\_}}}
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{\K{\#else}}}
\L{\LB{\K{int}\0\V{main}(\0\K{int}\0\V{argc},\0\K{char}\0\*\V{argv}[\,]\0)\0\{}}
\L{\LB{\K{\#endif}}}
\L{\LB{}\Tab{4}{\C{}\1\1\0body\0of\0main\0routine}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
which conditionally includes the correct definition for \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} if the program is compiled using \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{u}++}}\endlgrinde\LGend{}. 


\section{Labelled Break/Continue}
\label{s:LabelledBreakContinue}

While \CC provides \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{} and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{} statements for altering control flow, both are restricted to one level of nesting for a particular control structure.
Unfortunately, this restriction forces programmers to use \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{goto}}}\endlgrinde\LGend{} to achieve the equivalent for more than one level of nesting.
To prevent having to make this switch, \uC extends the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{}\index{break@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{}}\index{break@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{}!labelled}\index{labelled!break@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{}} and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{}\index{continue@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{}}\index{continue@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{}!labelled}\index{labelled!continue@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{}} with a target label to support static multi-level exit\index{multi-level exit}\index{static multi-level exit}~\cite{Buhr85,Java}.
For the labelled \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{}, it is possible to specify which control structure is the target for exit, e.g.:
\begin{flushleft}
\begin{tabular}{@{}l@{}l@{}}
...
\end{tabular}
\end{flushleft}
The innermost loop has three exit points, which cause termination of one or more of the three \Index{nested loop}s, respectively.
For the labelled \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{}, it is possible to specify which control structure is the target for the next loop iteration, e.g.:
\begin{flushleft}
\begin{tabular}{@{}l@{}l@{}}
\multicolumn{1}{c}{\textbf{\CC}} & \multicolumn{1}{c}{\textbf{\uC}}	\\
\LGinlinefalse\LGbegin\lgrinde
...
For both \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{} and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{}, the target label must be directly associated with a \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{for}}}\endlgrinde\LGend{}, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{while}}}\endlgrinde\LGend{} or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{do}}}\endlgrinde\LGend{} statement;
for \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{}, the target label can also be associated with a \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{switch}}}\endlgrinde\LGend{} or compound (\LGinlinetrue\LGbegin\lgrinde\L{\LB{\{\,\}}}\endlgrinde\LGend{}) statement, e.g.:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\V{L1}:\0\{}}
\L{\LB{}\Tab{4}{.\,.\,.\0\emph{declarations}\0.\,.\,.}}
\L{\LB{}\Tab{4}{\V{L2}:\0\K{switch}\0(\0.\,.\,.\0)\0\{}}
\L{\LB{}\Tab{8}{\V{L3}:\0\K{for}\0(\0.\,.\,.\0)\0\{}}
\L{\LB{}\Tab{12}{.\,.\,.\0\K{break}\0\V{L1};\0.\,.\,.\0\C{}\1\1\0exit\0compound\0statement}}
\CE{}\L{\LB{}\Tab{12}{.\,.\,.\0\K{break}\0\V{L2};\0.\,.\,.\0\C{}\1\1\0exit\0switch}}
\CE{}\L{\LB{}\Tab{12}{.\,.\,.\0\K{break}\0\V{L3};\0.\,.\,.\0\C{}\1\1\0exit\0loop}}
\CE{}\L{\LB{}\Tab{8}{\}}}
\L{\LB{}\Tab{8}{.\,.\,.}}
\L{\LB{}\Tab{4}{\}}}
\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{\}}}
\endlgrinde\LGend
Both \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{} and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{} with target labels are simply a \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{goto}}}\endlgrinde\LGend{}\index{goto@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{goto}}}\endlgrinde\LGend{}!restricted} restricted in the following ways: 
\begin{itemize}
\item
...
The advantage of the labelled \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{}/\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{} is that it allows static multi-level exits without having to use the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{goto}}}\endlgrinde\LGend{} statement and ties control flow to the target control structure rather than an arbitrary point in a program.
...
With \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{goto}}}\endlgrinde\LGend{}, the label at the end of the control structure fails to convey this important clue early enough to the reader.
Finally, using an explicit target for the transfer instead of an implicit target allows new nested loop or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{switch}}}\endlgrinde\LGend{} constructs to be added or removed without affecting other constructs.
The implicit targets of the current \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{break}}}\endlgrinde\LGend{} and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{continue}}}\endlgrinde\LGend{}, i.e., the closest enclosing loop or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{switch}}}\endlgrinde\LGend{}, change as certain constructs are added or removed.


\section{Finally Clause}
\label{s:FinallyClause}

The \CC \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{try}}}\endlgrinde\LGend{} block is augmented with a Java-style finally clause.
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{try}\0\{}}
\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{\}\0.\,.\,.\0\C{}\1\1\0catch\0clauses}}
...
The coroutine type has one distinguished member, named \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{};
...
The coroutine's execution-state is created and the starting point (\Index{activation point}) is initialized to the coroutine's \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} routine visible by the inheritance scope rules from the coroutine type;
...
\L{\LB{}\Tab{4}{\K{enum}\0\V{State}\0\{\0\V{Halt},\0\V{Active},\0\V{Inactive}\0\};}}
...
If the specified storage address is zero ( \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{}), the storage size becomes a stack size, as in the previous constructor.
\end{prefix}
A coroutine type can be designed to allow declarations to specify the stack storage and size by doing the following:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Coroutine}\0\V{C}\0\{}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{C}()\0:\0\V{uBaseCoroutine}(\08192\0)\0\{\};}\Tab{48}{\C{}\1\1\0default\08K\0stack}}
\CE{}\L{\LB{}\Tab{4}{\V{C}(\0\K{unsigned}\0\K{int}\0\V{s}\0)\0:\0\V{uBaseCoroutine}(\0\V{s}\0)\0\{\};\0\C{}\1\1\0user\0specified\0stack\0size}}
\CE{}\L{\LB{}\Tab{4}{\V{C}(\0\K{void}\0\*\V{st},\0\K{unsigned}\0\K{int}\0\V{s}\0)\0:\0\V{uBaseCoroutine}(\0\V{st},\V{s}\0)\0\C{}\1\1\0user\0specified\0stack\0storage\0and\0size}}
\CE{}\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{\};}}
...
A call to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{suspend}}}\endlgrinde\LGend{} may appear in any member of the coroutine, but normally it is used only in the coroutine main or non-public members called directly or indirectly from the coroutine main.
...
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{Prod}(\0\V{Cons}\0\&\V{c}\0)\0:\0\V{cons}(\V{c})\0\{\}}}
...
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{Cons}(\0\V{Prod}\0\&\V{p}\0)\0:\0\V{prod}(\V{p})\0\{}}
...
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{Prod}()\0:\0\V{receipt}(0)\0\{\}}}
...
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\};\0\C{}\1\1\0Prod}}
\CE{}\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
...
Similar to an execution state, a mutex object is either \Index{active}\index{monitor!active} or \Index{inactive}\index{monitor!inactive}, depending on whether or not a task is executing a mutex member (versus a task executing the coroutine main).
...
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{atomicounter}()\0\{\0\V{cnt}\0=\00;\0\}}}
\L{\LB{}\Tab{4}{\V{inc}()\0\{\0\V{cnt}\0+=\01;\0\}}\Tab{28}{\C{}\1\1\0atomically\0increment\0counter}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{for}\0(\0;;\0)\0\{}}
\L{\LB{}\Tab{4}{\K{\_Accept}(\0\~\V{DiskScheduler}\0)\0\{}\Tab{40}{\C{}\1\1\0request\0to\0terminate\0DiskScheduler}}
...
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{signal}();}\Tab{36}{\C{}\1\1\0signal\0condition}}
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{signalBlock}();}\Tab{36}{\C{}\1\1\0signal\0condition}}
\CE{}\L{\LB{}\Tab{4}{\K{bool}\0\V{empty}()\0\K{const};}}
\L{\LB{}\Tab{4}{\K{long}\0\K{int}\0\V{front}()\0\K{const};}}
\L{\LB{}}
...
The task type has one distinguished member, named \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}, in which the new thread starts execution;
this distinguished member is called the \newterm{task main}.
Instead of allowing direct interaction with \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}, its visibility is normally \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{private}}}\endlgrinde\LGend{} or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{protected}}}\endlgrinde\LGend{}.
...
-- creates a task on the current cluster with the cluster's default stack\index{stack!default size} size (see \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBaseCoroutine}()}}\endlgrinde\LGend{} p.~\pageref{p:uBaseCoroutine1}).

\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBaseTask}(\0\K{unsigned}\0\K{int}\0\V{stackSize}\0)}}\endlgrinde\LGend{}]
-- creates a task on the current cluster with the specified \emph{minimum} stack size (in bytes) (see \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBaseCoroutine}(\0\K{int}\0\V{stackSize}\0)}}\endlgrinde\LGend{} p.~\pageref{p:uBaseCoroutine2}).
...
(see \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBaseCoroutine}(\0\K{void}\0\*\V{storage},\0\K{unsigned}\0\K{int}\0\V{storageSize}\0)}}\endlgrinde\LGend{} p.~\pageref{p:uBaseCoroutine3}).
...
\L{\LB{\K{\_Task}\0\V{T}\0\{}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{T}()\0:\0\V{uBaseTask}(\08192\0)\0\{\};}\Tab{48}{\C{}\1\1\0current\0cluster,\0default\08K\0stack}}
\CE{}\L{\LB{}\Tab{4}{\V{T}(\0\K{unsigned}\0\K{int}\0\V{s}\0)\0:\0\V{uBaseTask}(\0\V{s}\0)\0\{\};}\Tab{48}{\C{}\1\1\0current\0cluster\0and\0user\0specified\0stack\0size}}
\CE{}\L{\LB{}\Tab{4}{\V{T}(\0\K{void}\0\*\V{st},\0\K{unsigned}\0\K{int}\0\V{s}\0)\0:\0\V{uBaseCoroutine}(\0\V{st},\V{s}\0)\0\C{}\1\1\0current\0cluster\0and\0user\0stack\0storage\0\&\0size}}
\CE{}\L{\LB{}\Tab{4}{\V{T}(\0\V{uCluster}\0\&\V{c}\0)\0:\0\V{uBaseTask}(\0\V{c}\0)\0\{\};}\Tab{48}{\C{}\1\1\0user\0cluster}}
\CE{}\L{\LB{}\Tab{4}{\V{T}(\0\V{uCluster}\0\&\V{c},\0\K{unsigned}\0\K{int}\0\V{s})\0:\0\V{uBaseTask}(\0\V{c},\0\V{s}\0)\0\{\};\0\C{}\1\1\0user\0cluster\0and\0stack\0size}}
\CE{}\L{\LB{}\Tab{4}{\V{T}(\0\V{uCluster}\0\&\V{c},\0\K{void}\0\*\V{st},\0\K{unsigned}\0\K{int}\0\V{s})\0:\0\V{uBaseTask}(\0\V{c},\0\V{st},\0\V{s}\0)\0\{\};\0\C{}\1\1\0user\0cluster,\0stack\0storage\0\&\0size}}
\CE{}\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{\};}}
...
One approach requires the task body (the code that appears in a \uC task's \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}) to be placed at the end of the new class's constructor, with code to start a new thread in \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Task}::\V{Task}()}}\endlgrinde\LGend{}.
...
The only exception to this rule is between a task and coroutine because the logical use of \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} is completely different between these kinds of type.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{owner}}}\endlgrinde\LGend{}\index{owner@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{owner}}}\endlgrinde\LGend{}} returns the task owning the lock or NULL if there is no owner.
...
\L{\LB{}\Tab{4}{\K{void}\0\V{signal}();}}
\L{\LB{}\Tab{4}{\K{void}\0\V{broadcast}();}}
\L{\LB{\};}}
...
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{block}}}\endlgrinde\LGend{}\index{block@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{block}}}\endlgrinde\LGend{}} is called to synchronize with $N$ tasks;
tasks block until any $N$ tasks have called \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{block}}}\endlgrinde\LGend{}.
...
The general form for a barrier \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} routine is:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\K{for}\0(\0;;\0)\0\{}}
...
All clients waiting for the result are unblocked, and an exception of type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Future\_ESM}::\V{Cancellation}}}\endlgrinde\LGend{} is thrown at any client attempting to access the result.
...
\CE{}\L{\LB{}}
\L{\LB{}\Tab{4}{\K{\_Event}\0\V{Cancellation}\0\{\};}\Tab{44}{\C{}\1\1\0raised\0if\0future\0cancelled}}
\CE{}\L{\LB{}\Tab{4}{\K{\_Nomutex}\0\K{bool}\0\V{cancelled}();}\Tab{44}{\C{}\1\1\0future\0result\0cancelled\0?}}
...
\index{Future_ESM@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Future\_ESM}}}\endlgrinde\LGend{}!Cancellation@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Cancellation}}}\endlgrinde\LGend{}}%
...
\CE{}\L{\LB{}}
\L{\LB{}\Tab{4}{\K{\_Event}\0\V{Cancellation}\0\{\};}\Tab{44}{\C{}\1\1\0raised\0if\0future\0cancelled}}
\CE{}\L{\LB{}\Tab{4}{\K{bool}\0\V{cancelled}();}\Tab{44}{\C{}\1\1\0future\0result\0cancelled\0?}}
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{cancel}();}\Tab{44}{\C{}\1\1\0cancel\0future\0result}}
\CE{}\L{\LB{}}
...
\index{Future_ISM@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Future\_ISM}}}\endlgrinde\LGend{}!Cancellation@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Cancellation}}}\endlgrinde\LGend{}}%
...
For example, in:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Select}(\0\V{f1}\0);\0\0\0\0$\equiv$\0\0\0\0\0\V{f1}();}}
\endlgrinde\LGend
the selector becomes \Index{select blocked} until \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{f1}.\V{available}()}}\endlgrinde\LGend{} is true, which is equivalent to calling the blocking future access-operator.
...
Like the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{\_Accept}}}\endlgrinde\LGend{} statement, it takes $2^{N}-1$ \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{if}}}\endlgrinde\LGend{} statements to simulate a compound \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{\_Select}}}\endlgrinde\LGend{} statement with $N$ \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{\_When}}}\endlgrinde\LGend{} guards (see p.~\pageref{p:ExponentialExpansion}).
...
calling drop on an empty ESM queue returns \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{}.
\end{prefix}
...
The middle structure in \VRef[Figure]{f:BasicServerStructures} handles multiple asynchronous calls by transforming the direct communication between client and server into indirect communication by composing the server as one of more worker tasks to perform computations and a monitor buffering future requests from asynchronous calls between client(s) and worker(s).
...
\L{\LB{}\Tab{12}{\V{server}\-\>\V{requests}[\V{requested}]\0=\0\V{NULL};}}
...
\L{\LB{}}
\L{\LB{}\Tab{12}{\K{while}\0(\0\V{cin}\0\>\>\0\V{id}\0)\0\{}}
...
\L{\LB{}\Tab{12}{\K{if}\0(\0\V{requests}[\V{value}]\0!=\0\V{NULL}\0)\0\{}}
...
The ESM server conditionally inserts the string into the future by checks if the future at position \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{value}}}\endlgrinde\LGend{} is \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} indicating it has been cancelled.
...
The future is then buffered in vector \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{requests}}}\endlgrinde\LGend{} until the input worker subsequently fills it in with a value, and server-specific data is filled into the future in case the client cancels the future.
...
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nworkers}\0=\04\0);}}
\L{\LB{}\Tab{4}{\K{template}\<\K{typename}\0\V{Return},\0\K{typename}\0\V{Func}\>\0\K{void}\0\V{submit}(\0\V{Future\_ISM}\<\V{Return}\>\0\&\V{result},\0\V{Func}\0\V{action}\0);}}
\L{\LB{\};}}
\endlgrinde\LGend
...
\label{p:uBaseCoroutine1}
-- creates an executor containing a work queue and $N$ worker threads, which are created on the current cluster with the cluster's default stack\index{stack!default size} size.
\end{prefix}

The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{submit}}}\endlgrinde\LGend{} queues a unit of work \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{action}}}\endlgrinde\LGend{} on a FIFO buffer in the executor to executed by on the $N$ worker threads.
...
%]
\VRef[Figure]{f:ExecutorExample} shows an example where work is submitted to an executor in the form of a routine and functor, and then different types of values (\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{int}}}\endlgrinde\LGend{}, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{double}}}\endlgrinde\LGend{}) are returned.
...
\L{\LB{}\Tab{4}{\C{}\1\1\0preform\0work}}
\CE{}\L{\LB{}\Tab{4}{\K{return}\03;}}
\L{\LB{\}}}
\L{\LB{\K{struct}\0\V{Functor}\0\{}\Tab{52}{\C{}\1\1\0closure:\0allows\0arguments\0to\0work}}
\CE{}\L{\LB{}\Tab{4}{\K{double}\0\V{x};}}
\L{\LB{}\Tab{4}{\K{double}\0\K{operator}()()\0\{}\Tab{52}{\C{}\1\1\0function\-call\0operator}}
\CE{}\L{\LB{}\Tab{8}{\C{}\1\1\0preform\0work}}
\CE{}\L{\LB{}\Tab{8}{\K{return}\0\V{x};}}
\L{\LB{}\Tab{4}{\}}}
\L{\LB{}\Tab{4}{\V{Functor}(\0\K{double}\0\V{x}\0)\0:\0\V{x}(\0\V{x}\0)\0\{\}}}
\L{\LB{\}\0\V{functor}(\04.5\0);}}
\L{\LB{}}
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\V{uExecutor}\0\V{executor};}}
\L{\LB{}\Tab{4}{\V{Future\_ISM}\<\K{int}\>\0\V{fi}[10];}}
\L{\LB{}\Tab{4}{\V{Future\_ISM}\<\K{double}\>\0\V{fd}[10];}}
\L{\LB{}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\010;\0\V{i}\0+=\01\0)\0\{}}
\L{\LB{}\Tab{8}{\V{executor}.\V{submit}(\0\V{fi}[\V{i}],\0\V{routine}\0);}\Tab{52}{\C{}\1\1\0think:\0fi[i]\0=\0executor.submit(\0routine\0)}}
\CE{}\L{\LB{}\Tab{8}{\V{executor}.\V{submit}(\0\V{fd}[\V{i}],\0\V{functor}\0);}\Tab{52}{\C{}\1\1\0think:\0fd[i]\0=\0executor.submit(\0functor\0)}}
\CE{}\L{\LB{}\Tab{4}{\}}}
\L{\LB{}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\010;\0\V{i}\0+=\01\0)\0\{}}
\L{\LB{}\Tab{8}{\V{cout}\0\<\<\0\V{fi}[\V{i}]()\0\<\<\0\S{}\"\0\"\SE{}\0\<\<\0\V{fd}[\V{i}]()\0\<\<\0\S{}\"\0\"\SE{};}\Tab{52}{\C{}\1\1\0wait\0for\0results}}
\CE{}\L{\LB{}\Tab{4}{\}}}
...
\L{\LB{}\Tab{4}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\S{}\"uvw\0\"\SE{}\0\<\<\0\S{}\"xyz\0\"\SE{}\0\<\<\0\V{endl};\0\C{}\1\1\0ok\0to\0acquire\0and\0release\0again}}
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\V{cin}.\V{tie}(\0\V{NULL}\0);}\Tab{20}{\C{}\1\1\0set\0tie\0partner\0to\0NULL}}
\CE{}\endlgrinde\LGend
...
\L{\LB{}\Tab{8}{\~\V{FileAccess}();}}
\L{\LB{}\Tab{4}{}}
\L{\LB{}\Tab{8}{\K{int}\0\V{read}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{8}{\K{int}\0\V{readv}(\0\K{const}\0\K{struct}\0\V{iovec}\0\*\V{iov},\0\K{int}\0\V{iovcnt},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{8}{\K{\_Mutex}\0\K{int}\0\V{write}(\0\K{const}\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{8}{\K{int}\0\V{writev}(\0\K{const}\0\K{struct}\0\V{iovec}\0\*\V{iov},\0\K{int}\0\V{iovcnt},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
...
\CE{}\L{\LB{}}
\L{\LB{\0\0\0\0\K{const}\0\K{char}\0\*\V{setName}(\0\K{char}\0\*\V{name}\0);}}
...
\L{\LB{}}
\L{\LB{}\Tab{4}{\K{int}\0\V{read}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{readv}(\0\K{const}\0\K{struct}\0\V{iovec}\0\*\V{iov},\0\K{int}\0\V{iovcnt},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{\_Mutex}\0\K{int}\0\V{write}(\0\K{const}\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{writev}(\0\K{const}\0\K{struct}\0\V{iovec}\0\*\V{iov},\0\K{int}\0\V{iovcnt},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{send}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{sendto}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{sendto}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{struct}\0\V{sockaddr}\0\*\V{to},\0\V{socklen\_t}\0\V{tolen},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{sendmsg}(\0\K{const}\0\K{struct}\0\V{msghdr}\0\*\V{msg},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{recv}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{recvfrom}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
...
\L{\LB{}\Tab{20}{\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{recvmsg}(\0\K{struct}\0\V{msghdr}\0\*\V{msg},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\V{ssize\_t}\0\V{sendfile}(\0\V{FileAccess}\0\&\V{file},\0\V{off\_t}\0\*\V{off},\0\V{size\_t}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
...
The \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{name}}}\endlgrinde\LGend{} parameter can be \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} for type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{SOCK\_DGRAM}}}\endlgrinde\LGend{}, if there is no initial server address.
...
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{uSocketAccept}(\0\V{uSocketServer}\0\&\V{s},\0\K{struct}\0\V{sockaddr}\0\*\V{adr}\0=\0\V{NULL},\0\V{socklen\_t}\0\*\V{len}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\V{uSocketAccept}(\0\V{uSocketServer}\0\&\V{s},\0\V{uDuration}\0\*\V{timeout},\0\K{struct}\0\V{sockaddr}\0\*\V{adr}\0=\0\V{NULL},\0\V{socklen\_t}\0\*\V{len}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\V{uSocketAccept}(\0\V{uSocketServer}\0\&\V{s},\0\K{bool}\0\V{doAccept},\0\K{struct}\0\V{sockaddr}\0\*\V{adr}\0=\0\V{NULL},\0\V{socklen\_t}\0\*\V{len}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\V{uSocketAccept}(\0\V{uSocketServer}\0\&\V{s},\0\V{uDuration}\0\*\V{timeout},\0\K{bool}\0\V{doAccept},\0\K{struct}\0\V{sockaddr}\0\*\V{adr}\0=\0\V{NULL},}}
\L{\LB{}\Tab{20}{\V{socklen\_t}\0\*\V{len}\0=\0\V{NULL}\0);}}
...
\CE{}\endlgrinde\LGend
However, an exception object declared as \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{const}}}\endlgrinde\LGend{}, as in:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{const}\0\V{E}\0\V{ce};}}
\endlgrinde\LGend
\emph{cannot} be used to raise a \uC exception (see~\VRef{s:constExceptions}).
...
if the exception has been raised locally, the value \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} is returned.
...
the default action is to call \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uAbort}}}\endlgrinde\LGend{} to terminate the program with the supplied message.
...
In \CC, the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{throw}}}\endlgrinde\LGend{} statement initializes a temporary object, the type of which is determined from the static type of the operand, and propagates the temporary object.
In \uC, the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{\_Throw}}}\endlgrinde\LGend{} and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{\_Resume}}}\endlgrinde\LGend{} statements throw an exception that is the type of the object referenced by the operand.
For example:
\begin{center}
\LGindent=0pt
\begin{tabular}{|l|l|}
...
\end{tabular}
\end{center}
in the \CC program, routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{f}}}\endlgrinde\LGend{} is passed an object of derived type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{D}}}\endlgrinde\LGend{} but throws an object of base type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{B}}}\endlgrinde\LGend{}, because the static type of the operand for throw, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{}, is of type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{B}}}\endlgrinde\LGend{}.
However, in the \uC program, routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{f}}}\endlgrinde\LGend{} is passed an object of derived type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{D}}}\endlgrinde\LGend{} and throws the original object of type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{D}}}\endlgrinde\LGend{}.
...
For example, in \VRef[Figure]{f:NonlocalPropagation} coroutine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{c}}}\endlgrinde\LGend{} loops until a nonlocal \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Done}}}\endlgrinde\LGend{} exception is raised at it by \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}.
Since coroutine control-flow is sequential, the exception type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Done}}}\endlgrinde\LGend{} is not propagated immediately.
...
Hence, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} must make a call to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{c}.\V{mem}}}\endlgrinde\LGend{} so \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{mem}}}\endlgrinde\LGend{} resumes \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{c}}}\endlgrinde\LGend{} and the pending exception is propagated.
...
\begin{figure}[htb]
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Event}\0\V{Done}\0\{\};}}
\L{\LB{}}
\L{\LB{\K{\_Coroutine}\0\V{C}\0\{}}
\L{\LB{}\Tab{4}{\K{void}\0\V{main}()\0\{}}
\L{\LB{}\Tab{8}{\K{try}\0\{}}
\L{\LB{}\Tab{12}{\K{\_Enable}\0\{}\Tab{32}{\C{}\1\1\0allow\0nonlocal\0exceptions}}
\CE{}\L{\LB{}\Tab{16}{\K{for}\0(\0;;\0)\0\{}}
\L{\LB{}\Tab{20}{.\,.\,.\0\V{suspend}();\0.\,.\,.}}
\L{\LB{}\Tab{16}{\}}}
\L{\LB{}\Tab{12}{\}}}
\L{\LB{}\Tab{8}{\}\0\K{catch}(\0\V{Done}\0)\0\{\0.\,.\,.\0\}}}
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\0\0\K{public}:}}
...
\L{\LB{}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\05;\0\V{i}\0+=\01\0)\0\V{c}.\V{mem}();}}
\L{\LB{}\Tab{4}{\K{\_Resume}\0\V{Done}()\0\K{\_At}\0\V{c};}\Tab{32}{\C{}\1\1\0deliver\0nonlocal\0exception}}
\CE{}\L{\LB{}\Tab{4}{\V{c}.\V{mem}();}\Tab{32}{\C{}\1\1\0trigger\0pending\0exception}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
\vspace{-4mm}
...
Initially, \Emph{nonlocal propagation is disabled for all exception types in a coroutine or task}, so handlers can be set up before any nonlocal exceptions can be propagated, resulting in the following \uC idiom in a coroutine or task main:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{main}()\0\{}}
...
\item the first time a coroutine/task's \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} routine is executed,
...
\begin{comment}
Unfortunately, \CC has no notion of nested routines, so there are restrictions on accessing local types/variables and member variables in containing scopes from a resumption handler.
First, types defined within a routine/member (\Index{local class}) cannot be used in a resumption handler.
Second, to access local and member variables in containing lexical scopes, the type and name of each local/member variable accessed must be specified after the exception type:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{try}\0\{}}
\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{\}\0\K{\_CatchResume}(\0\nterminal{exception-declaration}\0)\0{\color{red}( \nterminal{catchresume-argument-list} )}\0\{}}
\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{\}}}
\endlgrinde\LGend
\VRef[Figure]{f:SyntaxRestrictionsResumptionHandlers} illustrates all the accessible and inaccessible lexical types/variables in a resumption handler, and how to use the \nterminal{catchresume-argument-list} to access local/member variables in containing scopes.
For resumption handlers in member routines, it is often simplest to pass in an explicit \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{this}}}\endlgrinde\LGend{} pointer rather than listing all the accessed member variables, especially for called member routines.
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{class}\0\V{C}\0\{}}
\L{\LB{}\Tab{4}{\K{int}\0\V{x},\0\V{y},\0\V{z};}}
\L{\LB{}\Tab{4}{\K{void}\0\V{rtn1}()\0\{.\,.\,.\}}}
\L{\LB{}\Tab{4}{\K{void}\0\V{rtn2}()\0\{}}
\L{\LB{}\Tab{8}{\V{C}\0\*\V{This}\0=\0\K{this};}\Tab{48}{\C{}\1\1\0create\0explicit\0object\0pointer}}
\CE{}\L{\LB{}\Tab{8}{\K{try}\0\{}}
\L{\LB{}\Tab{12}{.\,.\,.}}
\L{\LB{}\Tab{8}{\}\0\K{\_CatchResume}(\0\V{R}\0\&\V{r}\0)\0(\0\V{C}\0\*\V{This}\0)\0\{}\Tab{48}{\C{}\1\1\0pass\0object\0to\0resumption\0handler}}
\CE{}\L{\LB{}\Tab{12}{\V{This}\-\>\V{rtn1}();\0\0\V{This}\-\>\V{rtn2}();}\Tab{48}{\C{}\1\1\0use\0\"This\"\0to\0access\0object\0members}}
\CE{}\L{\LB{}\Tab{12}{\V{cout}\0\<\<\0\V{This}\-\>\V{x}\0\<\<\0\V{This}\-\>\V{y}\0\<\<\0\V{This}\-\>\V{z}\0\<\<\0\V{endl};}}
\L{\LB{}\Tab{8}{\}\0}}
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\};}}
\endlgrinde\LGend
In the example, members \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{x}}}\endlgrinde\LGend{}, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{y}}}\endlgrinde\LGend{}, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{z}}}\endlgrinde\LGend{}, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{rtn1}}}\endlgrinde\LGend{}, and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{rtn2}}}\endlgrinde\LGend{} would have to be explicitly passed to the resumption handler because all are used within the handler.
Creating the local member-variable \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{This}}}\endlgrinde\LGend{}, initializing it to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{this}}}\endlgrinde\LGend{}, and passing \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{This}}}\endlgrinde\LGend{} to the handler allows the containing object to be accessible within the handler, but requires explicit qualification of each member with \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{This}\-\>}}\endlgrinde\LGend{}.

\begin{figure}
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Event}\0\V{R}\0\{\};}}
\L{\LB{}}
\L{\LB{\K{struct}\0\V{GlobalType}\0\{\};}}
\L{\LB{\K{int}\0\V{globalvar};}}
\L{\LB{}}
\L{\LB{\K{class}\0\V{C}\0\{}}
\L{\LB{}\Tab{4}{\K{struct}\0\V{ClassType}\0\{\};}}
\L{\LB{}\Tab{4}{\K{int}\0\V{membervar};}}
\L{\LB{}}
\L{\LB{}\Tab{4}{\K{void}\0\V{rtn}()\0\{}}
\L{\LB{}\Tab{8}{\K{struct}\0\V{RtnType}\0\{\};}\Tab{28}{\C{}\1\1\0local\0class}}
\CE{}\L{\LB{}\Tab{8}{\K{int}\0\V{rtnvar};}}
\L{\LB{}}
\L{\LB{}\Tab{8}{\K{try}\0\{}}
\L{\LB{}\Tab{12}{.\,.\,.}}
\L{\LB{}\Tab{8}{\}\0\K{\_CatchResume}(\0\V{R}\0\&\V{r}\0)\0{\color{red}( int membervar, int rtnvar )}\0\{\0\C{}\1\1\0catchresume\0arguments}}
\CE{}\L{\LB{}\Tab{12}{\V{GlobalType}\0\V{gv};}}
\L{\LB{}\Tab{12}{\V{ClassType}\0\V{cv};}}
\L{\LB{}\Tab{12}{\V{RtnType}\0\V{rv};}\Tab{28}{\C{}\1\1\0local\0class\0DOES\0NOT\0work\0in\0resumption\0handler}}
\CE{}\L{\LB{}\Tab{12}{\V{globalvar}\0=\03;}}
\L{\LB{}\Tab{12}{\V{membervar}\0=\03;}\Tab{28}{\C{}\1\1\0must\0be\0specified\0in\0containing\0scope\0list}}
\CE{}\L{\LB{}\Tab{12}{\V{rtnvar}\0=\03;}\Tab{28}{\C{}\1\1\0must\0be\0specified\0in\0containing\0scope\0list}}
\CE{}\L{\LB{}\Tab{8}{\}}}
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\};}}
\endlgrinde\LGend
\caption{Syntax/Restrictions for Resumption Handlers}
\label{f:SyntaxRestrictionsResumptionHandlers}
\end{figure}
\end{comment}
...
There is one interesting interaction between marking and the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{defaultResume}}}\endlgrinde\LGend{} member (see \VRef{s:ExceptionsInheritedMembers}):
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Event}\0\V{R}\0\{\};}}
\L{\LB{\K{void}\0\V{rtn}()\0\{}}
\L{\LB{}\Tab{4}{\K{try}\0\{}}
\L{\LB{}\Tab{8}{\K{\_Resume}\0\V{R}();}\Tab{24}{\C{}\1\1\0resume\0not\0throw}}
\CE{}\L{\LB{}\Tab{4}{\}\0\K{catch}(\0\V{R}\0\&\0)\0\{\0.\,.\,.\0\}}}
\L{\LB{\}}}
\endlgrinde\LGend
...
Hence, by examining the code, it is non-intuitive that the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{catch}}}\endlgrinde\LGend{} handler can be invoked.
...
Examples of abrupt (or non-graceful) termination include the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uAbort}}}\endlgrinde\LGend{} routine (\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{abort}}}\endlgrinde\LGend{} in \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{C}}}\endlgrinde\LGend{}) and the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{kill}\0\-9}}\endlgrinde\LGend{} command in UNIX.
...
\L{\LB{}\Tab{4}{\V{uBaseFuture}\<\V{T}\>::\V{Cancellation}}}
\endlgrinde\LGend
...
\index{SendfileTimeout@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{SendfileTimeout}}}\endlgrinde\LGend{}}%
\index{uBaseEvent@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBaseEvent}}}\endlgrinde\LGend{}!Cancellation@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Cancellation}}}\endlgrinde\LGend{}}%
...
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} has no resumption handler for \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBaseCoroutine}::\V{UnhandledException}}}\endlgrinde\LGend{};
...
\endlgrinde\LGend
It returns \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the rendezvous is ended;
...
\newterm[cancellation]{Cancellation} is a mechanism to safely terminate the execution of a coroutine or task.
...
Alternatively, ensuring a coroutine's \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} routine terminates prevents implicit cancellation.
...
In the program, after \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} creates the tasks, it waits for a solution to be found by any of the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Worker}}}\endlgrinde\LGend{} tasks.
If a \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Worker}}}\endlgrinde\LGend{} task finds a solution, it stores it in the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Result}}}\endlgrinde\LGend{} monitor and restarts \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} (if appropriate).
...
Hence, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} marks them all for cancellation and uses the result.
After the result has been processed, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} deletes the worker tasks, which allows for execution overlap of result processing with the worker tasks detecting, starting, and finishing cancellation.
Alternatively, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} can delete the workers right away, with the consequence that it may have to wait for the worker tasks to finish cancellation before processing the result.
...
\CE{}\L{\LB{}\Tab{8}{\V{c}.\V{signal}();}\Tab{48}{\C{}\1\1\0wake\0up\0uMain}}
\CE{}\L{\LB{}\Tab{4}{\}}}
\L{\LB{\};}}
\L{\LB{}}
\L{\LB{\K{\_Task}\0\V{Worker}\0\{}}
...
\L{\LB{\};}}
\L{\LB{}}
\L{\LB{\K{void}\0\V{uMain}::\V{main}\0()\0\{}}
...
\L{\LB{\0\0\K{private}:}}
\L{\LB{}\Tab{4}{\K{void}\0\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\0\0\V{fini}:}}
\L{\LB{}\Tab{8}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\010;\0\V{i}\0+=\01\0)\0\{}}
\L{\LB{}\Tab{12}{\K{\_Accept}(\0\V{mem}\0)\0\{}}
\L{\LB{}\Tab{16}{\K{break}\0\V{fini};}}
\L{\LB{}\Tab{12}{\}\0\K{\_Else};}}
\L{\LB{}\Tab{8}{\}}}
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\};}}
\endlgrinde\LGend
generates these warnings when using the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\-\V{Wall}}}\endlgrinde\LGend{} compiler flag (actually generated by the \CC compiler not \uC):
\begin{quote}
\BGfont
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\-\V{Wall}\0\-\V{Wno}\-\V{unused}\-\V{label}}}
\endlgrinde\LGend
...
To terminate a program, generate a core file, \emph{and} print an error message, use the \uC free routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uAbort}}}\endlgrinde\LGend{}:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{uAbort}(\0\K{char}\0\*\V{format}\0=\0\S{}\"\"\SE{},\0.\,.\,.\0)}}
\endlgrinde\LGend
\index{uAbort@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uAbort}}}\endlgrinde\LGend{}}%
...
\begin{annotation}
Because routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{exit}}}\endlgrinde\LGend{} eliminates some error checking, it should not be used to end \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} to pass back a return code to the shell, e.g.:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{}\Tab{4}{\V{exit}(\0\V{EXIT\_SUCCESS}\0);}}
\L{\LB{\}}}
\endlgrinde\LGend
Use the variable \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uRetCode}}}\endlgrinde\LGend{} from \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} instead (see \VRef{s:CompileTimeStructureuCProgram}).
\end{annotation}
...
\end{quote}
because no \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{try}}}\endlgrinde\LGend{} statement with an appropriate \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{catch}}}\endlgrinde\LGend{} clause is in effect for task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} so propagation fails to locate a matching handler.
...
Error occurred while executing task uMain (0xffbef000).
\end{quote}
because task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} deletes the monitor \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{m}}}\endlgrinde\LGend{} and then calls the member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{mem}}}\endlgrinde\LGend{} through the deleted pointer.
As a result, task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} finds the mutex object has been destroyed.
...
\CE{}\L{\LB{}\Tab{8}{\K{\_Accept}(\0\~\V{T1}\0);}\Tab{28}{\C{}\1\1\0uMain\0is\0calling\0the\0destructor}}
\CE{}\L{\LB{}\Tab{4}{\}}}
\L{\LB{\};}}
\endlgrinde\LGend
\LGinlinefalse\LGbegin\lgrinde
...
As a result, when task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} attempts to delete task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t1}}}\endlgrinde\LGend{}, it finds task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t2}}}\endlgrinde\LGend{} still blocked on the acceptor/signalled stack.
Similarly, the following program:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Task}\0\V{T1}\0\{}}
\L{\LB{\0\0\K{public}:}}
...
As a result, when task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} attempts to delete task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t1}}}\endlgrinde\LGend{}, it finds task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t2}}}\endlgrinde\LGend{} still blocked on the entry queue of \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t1}}}\endlgrinde\LGend{}.
...
\end{quote}
because in the call to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}.\V{mem}}}\endlgrinde\LGend{} from task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}, the rendezvous terminates abnormally by raising an exception of type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{E}}}\endlgrinde\LGend{}.
As a result, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} implicitly resumes an exception of type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMutexFailure}::\V{RendezvousFailure}}}\endlgrinde\LGend{}\index{uSerial@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uSerial}}}\endlgrinde\LGend{}!RendezvousFailure@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{RendezvousFailure}}}\endlgrinde\LGend{}}\index{RendezvousFailure@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{RendezvousFailure}}}\endlgrinde\LGend{}} concurrently at task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} so it knows the call did not complete and can take appropriate corrective action (see \VRef{s:BreakingRendezvous2}).
...
\end{quote}
because the blocked call to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}.\V{mem}}}\endlgrinde\LGend{} from task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} is interrupted by the \Index{concurrent exception}\index{exception!concurrent} of type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{E}}}\endlgrinde\LGend{}.
When the blocked call from \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} is accepted, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} immediately detects the concurrent exception and does not start the call.
...
As a result, when task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} attempts to delete task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t1}}}\endlgrinde\LGend{}, it finds task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t2}}}\endlgrinde\LGend{} still blocked on the condition queue.
...
a coroutine is terminated when its \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} routine returns.
The following program:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Coroutine}\0\V{C}\0\{}}
\L{\LB{}\Tab{4}{\K{void}\0\V{main}()\0\{\}}}
...
As a result, when \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} attempts the second call to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{c}.\V{mem}}}\endlgrinde\LGend{}, it finds coroutine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{c}}}\endlgrinde\LGend{} terminated.
...
Error occurred while executing task uMain (0xffbef008).
\end{quote}
because the call to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{C}::\V{mem}}}\endlgrinde\LGend{} executes a suspend before the coroutine's \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} member is started, and hence, there is no resumer to reactivate.
In general, member \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{suspend}}}\endlgrinde\LGend{} is only called within the coroutine main or non-public members called directly or indirectly from the coroutine main, not in public members called by other coroutines.
...
\L{\LB{}\Tab{4}{\K{return}\01000000000;}\Tab{28}{\C{}\1\1\0very\0large\0stack\0size\0for\0uMain}}
\CE{}\L{\LB{\}}}
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{\}}}
\endlgrinde\LGend
...
\end{quote}
because the declaration of \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} by the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBootTask}}}\endlgrinde\LGend{} fails due to the request for a 1000000000-byte stack\index{stack!overflow} for \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}.
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\K{char}\0\V{x}[\V{uThisCluster}().\V{getStackSize}()];}\Tab{44}{\C{}\1\1\0array\0larger\0than\0stack\0space}}
\CE{}\L{\LB{}\Tab{4}{\V{verify}();}}
\L{\LB{\}}}
\endlgrinde\LGend
generates this error:
\begin{quote}
...
Error occurred while executing task uMain (0xffbef008).
\end{quote}
because the declaration of the array in \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} uses more than the current stack space.
...
Error occurred while executing task uMain (0xffbef008).
\end{quote}
because the declaration of the array in \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} uses more than the current stack space, and by writing into the array, the current stack space is corrupted (and possibly another stack, as well).
...
\L{\LB{}\Tab{4}{\V{uCondition}\0\V{w};}}
\L{\LB{}\Tab{4}{\K{void}\0\V{main}()\0\{}}
\L{\LB{}\Tab{8}{\K{\_Accept}(\0\~\V{T}\0);}\Tab{28}{\C{}\1\1\0uMain\0invokes\0destructor}}
\CE{}\L{\LB{}\Tab{8}{\V{w}.\V{wait}();}\Tab{28}{\C{}\1\1\0T\0continues\0but\0blocks,\0which\0restarts\0uMain}}
\CE{}\L{\LB{}\Tab{4}{\}}}
\L{\LB{\};}}
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\V{T}\0\V{t};}}
...
\end{quote}
because the condition variable \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{w}}}\endlgrinde\LGend{} is passed from \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{}, and then there is a race to wait on the condition.
The error message shows that \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} waited first so it became the condition owner, and then \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{}'s attempt to wait fails. 
...
Error occurred while executing task uMain (0xffbef008).
\end{quote}
because task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} is first to wait on condition variable \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{w}}}\endlgrinde\LGend{} due to the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{yield}}}\endlgrinde\LGend{} in \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{}, and then \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} does not lock mutex-object \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} when calling \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{mem}}}\endlgrinde\LGend{} as it is nomutex.
Only if \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} has \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} locked can it access any condition variable owned by \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{}.
Changing \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{signal}}}\endlgrinde\LGend{} in \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{T}::\V{mem}}}\endlgrinde\LGend{} to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{wait}}}\endlgrinde\LGend{} generates a similar message with respect to waiting on a condition not locked by mutex object \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}.
...
\end{quote}
because the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBootTask}}}\endlgrinde\LGend{} happens to delete the user cluster (see \VRef{s:Cluster}) after \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} terminates before the dynamically allocated task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} has terminated.
Deleting the task associated with \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} \emph{before} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} terminates solves the problem.
...
\end{quote}
because the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBootTask}}}\endlgrinde\LGend{} deletes the user cluster (see \VRef{s:Cluster}) after \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} terminates but the dynamically allocated processor \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{p}}}\endlgrinde\LGend{} is still on the user cluster.
Deleting the processor associated with \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{p}}}\endlgrinde\LGend{} \emph{before} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} terminates solves the problem.
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\V{uThisCluster}().\V{select}(\0\-1,\00,\0\V{NULL}\0);}}
\L{\LB{\}}}
\endlgrinde\LGend
generates this error:
\begin{quote}
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\V{uThisCluster}().\V{select}(\0\-1,\0\V{NULL},\0\V{NULL},\0\V{NULL},\0\V{NULL}\0);}}
\L{\LB{\}}}
\endlgrinde\LGend
generates this error:
\begin{quote}
...
Possible cause is tasks are in a synchronization or mutual exclusion \Index{deadlock}.
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\K{int}\0\*\V{ip}\0=\0\V{NULL};}\Tab{28}{\C{}\1\1\0set\0address\0to\00}}
...
For some non-thread-safe UNIX library-routines, \uC provides a thread-safe equivalent, such as \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{abort}}}\endlgrinde\LGend{}\index{abort@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{abort}}}\endlgrinde\LGend{}}/\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uAbort}}}\endlgrinde\LGend{}\index{uAbort@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uAbort}}}\endlgrinde\LGend{}}, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{exit}}}\endlgrinde\LGend{}\index{exit@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{exit}}}\endlgrinde\LGend{}} (see \VRef{s:Termination}), \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{sleep}}}\endlgrinde\LGend{}\index{sleep@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{sleep}}}\endlgrinde\LGend{}}, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{usleep}}}\endlgrinde\LGend{}\index{usleep@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{usleep}}}\endlgrinde\LGend{}}, and the \uC I/O library (see \VRef[Chapter]{s:InputOutput}).
...
\L{\LB{}}
\L{\LB{}\Tab{4}{\K{int}\0\V{select}(\0\K{int}\0\V{fd},\0\K{int}\0\V{rwe},\0\V{timeval}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{select}(\0\K{int}\0\V{nfds},\0\V{fd\_set}\0\*\V{rfd},\0\V{fd\_set}\0\*\V{wfd},\0\V{fd\_set}\0\*\V{efd},\0\V{timeval}\0\*\V{timeout}\0=\0\V{NULL}\0);}}
\L{\LB{}}
...
\begin{prefix}
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{select}(\0\K{int}\0\V{fd},\0\K{int}\0\V{rwe},\0\V{timeval}\0\*\V{timeout}\0=\0\V{NULL}\0)}}\endlgrinde\LGend{}]
...
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{select}(\0\K{int}\0\V{nfds},\0\V{fd\_set}\0\*\V{rfd},\0\V{fd\_set}\0\*\V{wfd},\0\V{fd\_set}\0\*\V{efd},\0\V{timeval}\0\*\V{timeout}\0=\0\V{NULL}\0)}}\endlgrinde\LGend{}]
...
As well, the pthreads module containing the initial entry point \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} must be converted to the \uC member \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} (see~\VRef{s:CompileTimeStructureuCProgram}).
This change can be made conditionally using \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{\#ifdef}}}\endlgrinde\LGend{}s (see \VRef{s:PreprocessorVariables}) to allow a pthreads program to conditionally switch between running native pthreads or simulated pthreads in \uC depending on whether the program is compiled with \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{g}++}}\endlgrinde\LGend{}\index{GNU C++@GNU \CC} or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{u}++}}\endlgrinde\LGend{}\index{u++@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{u}++}}\endlgrinde\LGend{}}\index{compilation option!u++@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{u}++}}\endlgrinde\LGend{}}, e.g.:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\#ifdef}\0\V{\_\_U\_CPLUSPLUS\_\_}}}
\L{\LB{\K{void}\0\V{uMain}::\V{main}()\0\{}\Tab{24}{\C{}\1\1\0only\0change\0starting\0routine\0if\0compiled\0with\0u++}}
\CE{}\L{\LB{\K{\#else}}}
\L{\LB{\K{int}\0\V{main}(\0\K{int}\0\V{argc},\0\K{char}\0\*\V{argv}[\,]\0)\0\{}}
\L{\LB{\K{\#endif}}}
\L{\LB{}\Tab{4}{\C{}\1\1\0body\0of\0pthreads\0main\0routine}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
With these changes, the entire program can be compiled with \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{g}++}}\endlgrinde\LGend{}, or another compatible \CC compiler, to use native pthreads and linked with the pthreads (\LGinlinetrue\LGbegin\lgrinde\L{\LB{\-\V{lpthread}}}\endlgrinde\LGend{}) library.
Alternatively, the program can be complied with \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{u}++}}\endlgrinde\LGend{}, using the pthreads simulation provided by \uC.
...
In particular, the life time of a \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uPthreadable}}}\endlgrinde\LGend{} task is the same as an ordinary \uC task, and it becomes a monitor after its \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} routine ends.
The task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} is a \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uPthreadable}}}\endlgrinde\LGend{} task.
...
When the starting \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} routine ends, pthreads semantics cause immediate termination of the program and any outstanding threads, whereas \uC semantics require that all threads be programmatically terminated.
This inconsistency is resolved dynamically in favour of pthreads if any pthreads threads are running when \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{} ends.
...
In order to compile such a program with \uC, it is necessary to replace the special routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} by \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{}\index{uMain@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{}} (see Section \ref{s:CompileTimeStructureuCProgram}).
...
The specific argument to be passed depends on the \CC compiler used by \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{u}++}}\endlgrinde\LGend{}: the Intel \CC compiler uses \LGinlinetrue\LGbegin\lgrinde\L{\LB{\-\V{openmp}}}\endlgrinde\LGend{}\index{-openmp@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\-\V{openmp}}}\endlgrinde\LGend{} option}\index{compilation option!-openmp@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\-\V{openmp}}}\endlgrinde\LGend{}}, whereas the GNU \CC compiler uses \LGinlinetrue\LGbegin\lgrinde\L{\LB{\-\V{fopenmp}}}\endlgrinde\LGend{}\index{-fopenmp@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\-\V{fopenmp}}}\endlgrinde\LGend{} option}\index{compilation option!-fopenmp@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\-\V{fopenmp}}}\endlgrinde\LGend{}}.
...
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{uTime}();}}
\L{\LB{}\Tab{4}{\V{uTime}(\0\K{long}\0\K{int}\0\V{sec}\0);}}
\L{\LB{}\Tab{4}{\V{uTime}(\0\K{long}\0\K{int}\0\V{sec},\0\K{long}\0\K{int}\0\V{nsec}\0);}}
...
\L{\LB{\V{gettimeofday}(\0\&\V{t1},\0\V{NULL}\0);}\Tab{28}{\C{}\1\1\0current\0time\0(seconds\0\1\0microseconds)}}
...
Like a task, a periodic task type has one distinguished member, named \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}, in which the new thread starts execution.
...
\L{\LB{\};}}
\endlgrinde\LGend
The task body, i.e., routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}, is implicitly surrounded with a loop that performs the task body periodically.
...
falling off the end of the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} routine does not terminate a periodic task.
...
\begin{sloppypar}
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{getInheritTask}}}\endlgrinde\LGend{} returns the task that this task inherited its current active priority from or NULL.
...
In the example, the creation of the real-time scheduler and cluster is done at the beginning of \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}::\V{main}}}\endlgrinde\LGend{}.
...
Routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMainStackSize}}}\endlgrinde\LGend{} is used directly to provide a stack size for the implicitly declared initial task of type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} (see \VRef{s:CompileTimeStructureuCProgram}).
...
\end{list}
\uC requires at least GNU~\cite{GNU-C++}\index{GNU C++@GNU \CC} g++-4.0.3 or greater for Linux and g++-4.2.1 or greater for Solaris. %, or Intel icc 10.1 or greater.
...
% switching to sh
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\V{\$}\0\V{sudo}\0\V{sh}\0\V{u}++\-6.1.0.sh}}
\endlgrinde\LGend
%$
% switching to u++
...
If \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{ptr}}}\endlgrinde\LGend{} is \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{}, the minimal alignment for any allocation is returned, e.g., multiple of 8.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{head}}}\endlgrinde\LGend{}\index{head@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{head}}}\endlgrinde\LGend{}} returns a pointer to the top node of the stack without removing it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the stack has no nodes.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{drop}}}\endlgrinde\LGend{}\index{drop@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{drop}}}\endlgrinde\LGend{}} removes a node from the top of the stack and returns a pointer to it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the stack has no nodes.
...
otherwise the argument is set to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{false}}}\endlgrinde\LGend{} is returned.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{head}}}\endlgrinde\LGend{}\index{head@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{head}}}\endlgrinde\LGend{}} returns a pointer to the head or first node of the queue without removing it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the queue has no nodes.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{succ}}}\endlgrinde\LGend{}\index{succ@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{succ}}}\endlgrinde\LGend{}} returns a pointer to the successor node after the specified node (toward the tail) or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the specified node is the last node in the sequence.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropHead}}}\endlgrinde\LGend{}\index{dropHead@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropHead}}}\endlgrinde\LGend{}} removes a node from the head or front of the queue and returns a pointer to it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the queue has no nodes.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropTail}}}\endlgrinde\LGend{}\index{dropTail@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropTail}}}\endlgrinde\LGend{}} removes a node from the tail or end of the queue and returns a pointer to it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the queue has no nodes.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{head}}}\endlgrinde\LGend{}\index{head@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{head}}}\endlgrinde\LGend{}} returns a pointer to the head or first node of the sequence without removing it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the sequence has no nodes.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{tail}}}\endlgrinde\LGend{}\index{tail@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{tail}}}\endlgrinde\LGend{}} returns a pointer to the tail or last node of the sequence without removing it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the sequence has no nodes.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{succ}}}\endlgrinde\LGend{}\index{succ@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{succ}}}\endlgrinde\LGend{}} returns a pointer to the successor node after the specified node (toward the tail) or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the specified node is the last node in the sequence.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{pred}}}\endlgrinde\LGend{}\index{pred@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{pred}}}\endlgrinde\LGend{}} returns a pointer to the predecessor node before the specified node (toward the head) or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the specified node is the first node in the sequence.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{insertBef}}}\endlgrinde\LGend{}\index{insertBef@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{insertBef}}}\endlgrinde\LGend{}} adds a node before the specified node or at the end (tail) if \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{bef}}}\endlgrinde\LGend{} is \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{}.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{insertAft}}}\endlgrinde\LGend{}\index{insertAft@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{insertAft}}}\endlgrinde\LGend{}} adds a node after the specified node or at the beginning (head) if \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{aft}}}\endlgrinde\LGend{} is \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{}.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{add}}}\endlgrinde\LGend{}\index{add@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{add}}}\endlgrinde\LGend{}} is a synonym for \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{addTail}}}\endlgrinde\LGend{}.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropHead}}}\endlgrinde\LGend{}\index{dropHead@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropHead}}}\endlgrinde\LGend{}} removes a node from the head or front of the sequence and returns a pointer to it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the sequence has no nodes.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{drop}}}\endlgrinde\LGend{}\index{drop@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{drop}}}\endlgrinde\LGend{}} is a synonym for \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropHead}}}\endlgrinde\LGend{}.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropTail}}}\endlgrinde\LGend{}\index{dropTail@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{dropTail}}}\endlgrinde\LGend{}} removes a node from the tail or end of the sequence and returns a pointer to it or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} if the sequence has no nodes.
